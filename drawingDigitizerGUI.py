...
class DrawingDigitizerGUI(QDialog):
    ...
    def _setupUi(self):
        ...
        self.toolButtonRemoveRows.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.tblCoords.setSelectionBehavior(QAbstractItemView.SelectionBehavior.SelectRows)
    ...
    def _updateCoordList(self, incremental=False):
        ...
        if incremental and self.tblCoords.rowCount() == len(self.points) - 1:
            ...
            itemX.setTextAlignment(Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignVCenter)
            itemY = QTableWidgetItem('%.2f' % y)
            itemY.setData(Qt.ItemDataRole.UserRole, y)
            itemY.setTextAlignment(Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignVCenter)
