...
class Ui_numericalDigitize_MainDialog(object):
    def setupUi(self, numericalDigitize_MainDialog):
        ...
        self.gridMainLayout.setSizeConstraint(
        ...
        self.twPoints.setSelectionMode(
        ...
        self.buttonsFrameLayout.setSizeConstraint(
        ...
        sizePolicy.setHeightForWidth(
            self.partButtonsFrame.sizePolicy().hasHeightForWidth()
        )
        ...
        self.partButtonsLayout.setSizeConstraint(
            QtWidgets.QLayout.SizeConstraint.SetDefaultConstraint
        )
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(
            QtGui.QPixmap(":/plugins/numericalDigitize/images/mActionAddPart.svg"),
            QtGui.QIcon.Mode.Normal,
            QtGui.QIcon.State.Off,
        )
        self.toolButtonAddPart.setIcon(icon)
        self.toolButtonAddPart.setIconSize(QtCore.QSize(32, 32))
        self.toolButtonAddPart.setToolButtonStyle(
        ...
        self.toolButtonRemovePart.setContextMenuPolicy(
            QtCore.Qt.ContextMenuPolicy.DefaultContextMenu
        )
        icon1 = QtGui.QIcon()
        icon1.addPixmap(
            QtGui.QPixmap(":/plugins/numericalDigitize/images/mActionDeletePart.svg"),
            QtGui.QIcon.Mode.Normal,
            QtGui.QIcon.State.Off,
        )
        self.toolButtonRemovePart.setIcon(icon1)
        self.toolButtonRemovePart.setIconSize(QtCore.QSize(32, 32))
        self.toolButtonRemovePart.setToolButtonStyle(
            QtCore.Qt.ToolButtonStyle.ToolButtonIconOnly
        )
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(
            QtGui.QPixmap(":/plugins/numericalDigitize/images/mActionAddRing.svg"),
            QtGui.QIcon.Mode.Normal,
            QtGui.QIcon.State.Off,
        )
        ...
        self.toolButtonUndoPart.setToolButtonStyle(
            QtCore.Qt.ToolButtonStyle.ToolButtonIconOnly
        )
        self.toolButtonUndoPart.setObjectName("toolButtonUndoPart")
        self.partButtonsLayout.addWidget(self.toolButtonUndoPart)
        self.buttonsFrameLayout.addWidget(
            self.partButtonsFrame, 0, QtCore.Qt.AlignmentFlag.AlignLeft
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.rowButtonsFrame.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.toolButtonCopy.sizePolicy().hasHeightForWidth()
        )
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(
            QtGui.QPixmap(":/plugins/numericalDigitize/images/mActionEditCopy.svg"),
            QtGui.QIcon.Mode.Normal,
            QtGui.QIcon.State.Off,
        )
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(
            QtGui.QPixmap(":/plugins/numericalDigitize/images/mActionEditPaste.svg"),
            QtGui.QIcon.Mode.Normal,
            QtGui.QIcon.State.Off,
        )
        self.toolButtonPaste.setIcon(icon4)
        self.toolButtonPaste.setIconSize(QtCore.QSize(32, 32))
        self.toolButtonPaste.setToolButtonStyle(
            QtCore.Qt.ToolButtonStyle.ToolButtonIconOnly
        )
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(
            QtGui.QPixmap(":/plugins/numericalDigitize/images/swap.svg"),
            QtGui.QIcon.Mode.Normal,
            QtGui.QIcon.State.Off,
        )
        self.toolButtonSwap.setIcon(icon5)
        self.toolButtonSwap.setIconSize(QtCore.QSize(24, 24))
        self.toolButtonSwap.setToolButtonStyle(
            QtCore.Qt.ToolButtonStyle.ToolButtonIconOnly
        )
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(
            QtGui.QPixmap(":/plugins/numericalDigitize/images/mActionNewTableRow.svg"),
            QtGui.QIcon.Mode.Normal,
            QtGui.QIcon.State.Off,
        )
        self.toolButtonAddRows.setIcon(icon6)
        self.toolButtonAddRows.setIconSize(QtCore.QSize(32, 32))
        self.toolButtonAddRows.setToolButtonStyle(
            QtCore.Qt.ToolButtonStyle.ToolButtonIconOnly
        )
        self.toolButtonAddRows.setObjectName("toolButtonAddRows")
        self.buttonsRowLayout.addWidget(
            self.toolButtonAddRows, 0, QtCore.Qt.AlignmentFlag.AlignLeft
        )
        ...
        self.toolButtonRemoveRows.setContextMenuPolicy(
            QtCore.Qt.ContextMenuPolicy.DefaultContextMenu
        )
        icon7 = QtGui.QIcon()
        icon7.addPixmap(
            QtGui.QPixmap(
                ":/plugins/numericalDigitize/images/mActionDeleteTableRow.svg"
            ),
            QtGui.QIcon.Mode.Normal,
            QtGui.QIcon.State.Off,
        )
        ...
        self.buttonsFrameLayout.addWidget(
            self.rowButtonsFrame, 0, QtCore.Qt.AlignmentFlag.AlignLeft
        )
    ...
    def retranslateUi(self, numericalDigitize_MainDialog):
        ...
        numericalDigitize_MainDialog.setWindowTitle(
            _translate("numericalDigitize_MainDialog", "Add numerical feature")
        )
        self.groupBox.setTitle(
            _translate("numericalDigitize_MainDialog", "CRS Selection")
        )
        self.tbSelectCrs.setToolTip(
            _translate("numericalDigitize_MainDialog", "Select CRS")
        )
        ...
        self.toolButtonAddPart.setToolTip(
            _translate("numericalDigitize_MainDialog", "Add part")
        )
        self.toolButtonAddPart.setText(
            _translate("numericalDigitize_MainDialog", "...")
        )
        self.toolButtonRemovePart.setToolTip(
            _translate("numericalDigitize_MainDialog", "Remove part")
        )
        self.toolButtonRemovePart.setText(
            _translate("numericalDigitize_MainDialog", "...")
        )
        self.toolButtonAddRing.setToolTip(
            _translate("numericalDigitize_MainDialog", "Add polygon ring")
        )
        self.toolButtonAddRing.setText(
            _translate("numericalDigitize_MainDialog", "...")
        )
        self.toolButtonUndoPart.setToolTip(
            _translate("numericalDigitize_MainDialog", "Undo delete part")
        )
        self.toolButtonUndoPart.setText(
            _translate("numericalDigitize_MainDialog", "...")
        )
        self.toolButtonCopy.setToolTip(
            _translate("numericalDigitize_MainDialog", "Copy to clipboard")
        )
        self.toolButtonCopy.setText(_translate("numericalDigitize_MainDialog", "..."))
        self.toolButtonPaste.setToolTip(
            _translate("numericalDigitize_MainDialog", "Paste from clipboard")
        )
        self.toolButtonPaste.setText(_translate("numericalDigitize_MainDialog", "..."))
        self.toolButtonSwap.setToolTip(
            _translate("numericalDigitize_MainDialog", "Swap values of X and Y columns")
        )
        self.toolButtonSwap.setText(_translate("numericalDigitize_MainDialog", "..."))
        self.toolButtonAddRows.setToolTip(
            _translate("numericalDigitize_MainDialog", "Add row")
        )
        self.toolButtonAddRows.setText(
            _translate("numericalDigitize_MainDialog", "...")
        )
        self.toolButtonRemoveRows.setToolTip(
            _translate("numericalDigitize_MainDialog", "Delete rows")
        )
        self.toolButtonRemoveRows.setText(
            _translate("numericalDigitize_MainDialog", "...")
        )
